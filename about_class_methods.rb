...
class AboutClassMethods < Neo::Koan
  ...
  # Curious if this module stuff works in class << self
  module GabbaGabba
    def gabba
      :hey
    end
  ...
  def test_module_included_in_for_class_methods
    barf = Dog.new
    assert_equal :hey, barf.class.gabba
    assert_equal barf.class, barf.class.thatself
  end
